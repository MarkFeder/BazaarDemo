...
public partial class ProductRepository : LinqRepository<BazaarDemo.BackEnd.Domain.Entities.Product>,IProductRepository
{
    public ProductRepository (System.Data.Entity.DbContext context) : base(context)
    {
