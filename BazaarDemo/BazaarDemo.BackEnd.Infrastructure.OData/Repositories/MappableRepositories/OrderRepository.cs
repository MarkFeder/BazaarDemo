...
{
    public class OrderRepository : MappableEntityRepository<Order, OrderModel>
    {
        public OrderRepository(System.Data.Entity.DbContext entities, IObjectMapper mapper) : base(entities, mapper)
        {
